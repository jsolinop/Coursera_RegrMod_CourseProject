...
\hypersetup{
  pdftitle={MPG analisys - Motor Trends},
  pdfauthor={Joaquín Soliño},
  hidelinks,
...
\title{MPG analisys - Motor Trends}
...
\hypertarget{prompts-for-the-project}{%
\subsection{Prompts for the project}\label{prompts-for-the-project}}
...
\includegraphics{Regression-Models---Course-Project---JSolino_files/figure-latex/pressure-1.pdf}
